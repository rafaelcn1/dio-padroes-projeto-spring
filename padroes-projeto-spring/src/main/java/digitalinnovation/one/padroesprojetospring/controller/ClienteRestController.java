package digitalinnovation.one.padroesprojetospring.controller;
...
public class ClienteRestController {
	...
	public ResponseEntity<Iterable<Cliente>> buscarTodos() {
		...
		ResponseEntity<Iterable<Cliente>> buscaTodosOk = ResponseEntity.ok(buscarTodos);
		return buscaTodosOk;
	}
	...
	public ResponseEntity<Cliente> buscarPorId(@PathVariable Long id) {
		...
		ResponseEntity<Cliente> buscaPorIdOk = ResponseEntity.ok(buscarPorId);
		return buscaPorIdOk;
	}
